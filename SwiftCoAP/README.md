...
###Import this Swift Package
1) Add this swift package into your project in Xcode 11+ (File-->Swift Pacakge-->add package dependency). Or manually add it into your swift package dependencies in ... `Package.swift` ...
...
2) Make sure to  `#import SwiftCoAP` ...
